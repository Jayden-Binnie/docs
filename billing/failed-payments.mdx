...
<iframe src="https://scribehow.com/embed/Create_a_Subscription_for_a_Customer_in_Stripe__N5KSwqvHQ9qJniPVjhAeDw?removeLogo=true" width="100%" height="800" allow="fullscreen" style={{ aspectRatio: "1 / 1", border: "0", minHeight: "480px" }}></iframe>