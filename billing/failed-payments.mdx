...
description: "When a student misses payment they will immediately start receiving the following reminders."
---

<Steps>
  <Step title="First Attempt Fails">
    The student will recieve this email with a link to pay via a stripe hosted page. Email opens are tracked.
  ...
  <Step title="Third Attempt Fails (2 Retries)">
    ...
    ![IMG 4309 PN](/images/IMG_4309.PNG)

    {/* add content here later, or another <Frame> if you want */}
  </Step>
  <Step title="Fifth Attempt Fails (4 Retries)">
    ![Screenshot2025 09 23004543 Pn](/images/Screenshot2025-09-23004543.png)
  </Step>
  <Step title="Eighth Attempt Fails (7 Retries)">
    ...
    ![IMG 4308 PN](/images/IMG_4308.PNG)
  </Step>
</Steps>
...
![Untitleddesign Pn](/images/Untitleddesign.png)
